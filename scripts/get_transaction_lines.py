"""MCP helper: read operation lines (FIN-270 / FIN-272)."""
...
def get_transaction_lines(
    ...
    *,
    ...
    """
    Read operation lines via FIN-272 ``GET …/lines``.
    ...
    path = f"/api/v1/transactions/{urllib.parse.quote(tx_id, safe='')}/lines"
