...
**Домен:** [classification.md](../../../PycharmProjects/FinancePlanningProject/.specs/transactions/classification.md); mcp-only — [mcp-only.md](../../../assistant/35-finance-assistant/methodology/monthly-close-api/mcp-only.md).
