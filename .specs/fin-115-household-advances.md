...
**Домен:** аванс на базовые потребности — [household-budget-model.md](../../../assistant/35-finance-assistant/methodology/household-budget-model.md) (§ «Аванс на базовые потребности»); partner ids — [household-contour-mapping.{profile}.json](../../../assistant/35-finance-assistant/methodology/household-contour-mapping.prod.json).
